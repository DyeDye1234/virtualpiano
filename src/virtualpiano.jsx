...
function VirtualPiano() {
    ...
    return (<div>
        ...
        <div className="container">
            ...
            <PianoKey type="black">2</PianoKey>
            <PianoKey>W</PianoKey>
            <PianoKey type="black">3</PianoKey>
            <PianoKey>E</PianoKey>
            <PianoKey>R</PianoKey>
            <PianoKey type="black">5</PianoKey>
            <PianoKey>T</PianoKey>
            <PianoKey type="black">6</PianoKey>
            <PianoKey>Y</PianoKey>
            <PianoKey type="black">7</PianoKey>
            <PianoKey>U</PianoKey>
        </div>
    </div>)
